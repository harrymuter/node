    ...
    $("#select-builder").submit(function(e) {
        ...
        if (form.required="no") {
            var html = '<div class="row col-12 ' + stamp + '" data-identifier="' + stamp + '">' +
                '<div class="row col-12"><label class="col-4 col-form-label" for="' + stamp + '">' + form.select_input + '</label>' +
            ...
            for (var i = 0; i < custom_select.length; i++) {
                ...
                html += '<option value="'+form[val]+'">'+form[option]+'</option>';
            }
            ...
            var html = '<div class="row col-12 ' + stamp + '" data-identifier="' + stamp + '">' +
                '<div class="row col-12"><label class="col-4 col-form-label" for="' + stamp + '">' + form.select-input + ' *' + '</label>' +
                '<div class="form-group col-4">' +
        ...
        if(form_name!=="") {
            if(subtitle!=="") {
                $.ajax({
                    ...
                    success: window.location.href = '/forms?type='+form_type
                });
            } else {
